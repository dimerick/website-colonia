...
<head>
    ...
    <link href="{{asset('assets/css/leaflet1/leaflet.css')}}" rel="stylesheet">
    <link href="{{asset('assets/css/iconLayers.css')}}" rel="stylesheet">
    <link href="{{asset('assets/css/Control.FullScreen.css')}}" rel="stylesheet">
    <link href="{{asset('assets/css/leaflet1/MarkerCluster.css')}}" rel="stylesheet">
    <link href="{{asset('assets/css/leaflet1/MarkerCluster.Default.css')}}" rel="stylesheet">
    <link href="{{asset('assets/css/leaflet-search.css')}}" rel="stylesheet">
...
<script type="text/javascript" src="{{asset('assets/js/leaflet1/leaflet.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/proj4.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/iconLayers.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/Control.FullScreen.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/leaflet1/leaflet.markercluster.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/proj4leaflet.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/leaflet-search.js')}}"></script>
