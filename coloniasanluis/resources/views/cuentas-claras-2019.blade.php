                ...
                <section class="section-rendicion-cuentas">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a target="_blank" href="{{asset('documentation/2019/acta-asamblea.pdf')}}">Acta de Asamblea Colonia</a><br>

                                <a target="_blank" href="{{asset('documentation/2019/camara_comercio.pdf')}}">Certificado de Existencia Colonia</a><br>

                                <!-- <a target="_blank" href="{{asset('documentation/DeclaraciondeRentas.pdf')}}">Declaración de Rentas</a><br> -->

                                <a target="_blank" href="{{asset('documentation/2019/estados_financieros.pdf')}}">Estados Financieros Colonia</a><br>

                                <!-- <a target="_blank" href="{{asset('documentation/EstatutosColonia.pdf')}}">Estatutos Colonia</a><br> -->

                                <a target="_blank" href="{{asset('documentation/2019/informe_gestion_2018.pdf')}}">Informe de Gestión Colonia</a><br>

                                <a target="_blank" href="{{asset('documentation/2019/certificado_cumplimiento.pdf')}}">Certificado de Cumplimiento</a><br>

                                <a target="_blank" href="{{asset('documentation/2019/certificado_salarial.pdf')}}">Certificado Salarial</a><br>

                                <a target="_blank" href="{{asset('documentation/2019/certificado_antecedentes.pdf')}}">Certificado Antecedentes Miembros</a><br>
